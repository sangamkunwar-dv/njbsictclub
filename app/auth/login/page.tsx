  ...
  return (
    <div className="w-full max-w-[400px] p-8 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-xl dark:shadow-2xl transition-colors duration-300">
      ...
      <div className="relative mb-8">
        ...
        <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em] font-bold"><span className="bg-white dark:bg-zinc-950 px-3 text-zinc-400">Secure Email Login</span></div>
      </div>
