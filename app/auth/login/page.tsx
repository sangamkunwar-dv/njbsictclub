    ...
    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          type="button"
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition font-medium text-gray-700"
        >
        ...
        <button
          ...
          type="button"
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-900 text-white rounded-xl hover:bg-gray-800 transition font-medium"
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <Link href="/auth/forgot-password" weight="medium" className="text-indigo-600 hover:text-indigo-700 font-medium">
            Forgot password?
          </Link>
        </div>
...
// 2. Main Page component wraps everything in Suspense
